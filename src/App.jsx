      ...
      <div className='w-screen h-screen bg-zinc-600'>
        <div className='w-full h-3/4 flex flex-col justify-center items-center'>
          <div className='md:w-[450px] sm:w-[400px] w-4/5 flex flex-col gap-3 justify-center items-center'>
            ...
            <button className='absolute bg-blue-700 text-white font-semibold px-2 py-1 rounded-md sm:text-base text-sm' type="button" onClick={swap}>SWAP</button>
          </div>
          <div className='bg-blue-700 md:w-[450px] sm:w-[400px] w-4/5 text-center h-[35px] rounded-md text-white mt-4' >Converting  {from} to  {to}</div>
        </div>
      </div>
    </>
  )
